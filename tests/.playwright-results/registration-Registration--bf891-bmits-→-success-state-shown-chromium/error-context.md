...
- Name: registration.spec.ts >> Registration form >> happy path: fills form, checks gdpr, submits → success state shown
- Location: web/registration.spec.ts:31:3
...
- dialog:
  ...
  - textbox "Jane Smith": Playwright User
  - text: Work email *
  - textbox "jane@company.com": playwright@e2e.test
  - text: Company
  - textbox "Acme Corp"
  - text: Job title
