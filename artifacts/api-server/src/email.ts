...
<head>
  ...
  <title>You're booked — ${eventTitle}</title>
</head>
      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);max-width:560px;">
        ...
        <tr>
          <td style="background:linear-gradient(135deg,#0a2540 0%,#0f3460 100%);padding:32px 40px 28px;">
            ...
            <p style="margin:0;font-size:12px;color:#94a3b8;letter-spacing:0.6px;text-transform:uppercase;">Booking Confirmation</p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:36px 40px 0;">
            <p style="margin:0 0 6px;font-size:12px;font-weight:700;color:#0ea5e9;text-transform:uppercase;letter-spacing:1px;">You're booked ✅</p>
            ...
            <p style="margin:0 0 28px;font-size:15px;color:#475569;line-height:1.65;">
              Hi ${firstName}, your spot at <strong style="color:#0a2540;">${eventTitle}</strong> is confirmed. We'll see you on court!
            </p>
          </td>
        </tr>
          ...
          <td style="padding:0 40px 28px;">
            <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;">
              <tr><td style="padding:16px 24px 4px;">
                <p style="margin:0;font-size:11px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:0.8px;">Event Details</p>
              </td></tr>
              <tr><td style="padding:4px 24px 20px;">
                <table width="100%" cellpadding="0" cellspacing="0">
                  <tr><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;">
                    <table cellpadding="0" cellspacing="0"><tr>
                      <td width="28" style="font-size:16px;vertical-align:top;padding-top:1px;">📅</td>
                      <td><p style="margin:0;font-size:11px;color:#94a3b8;text-transform:uppercase;letter-spacing:0.6px;font-weight:600;">Date</p>
                          <p style="margin:2px 0 0;font-size:14px;color:#0a2540;font-weight:600;">${eventDate}</p></td>
                    </tr></table>
                  </td></tr>
                  <tr><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;">
                    <table cellpadding="0" cellspacing="0"><tr>
                      <td width="28" style="font-size:16px;vertical-align:top;padding-top:1px;">🕖</td>
                      <td><p style="margin:0;font-size:11px;color:#94a3b8;text-transform:uppercase;letter-spacing:0.6px;font-weight:600;">Time</p>
                          <p style="margin:2px 0 0;font-size:14px;color:#0a2540;font-weight:600;">${eventTime}</p></td>
                    </tr></table>
                  </td></tr>
                  <tr><td style="padding:10px 0;">
                    <table cellpadding="0" cellspacing="0"><tr>
                      <td width="28" style="font-size:16px;vertical-align:top;padding-top:1px;">📍</td>
                      <td><p style="margin:0;font-size:11px;color:#94a3b8;text-transform:uppercase;letter-spacing:0.6px;font-weight:600;">Venue</p>
                          <p style="margin:2px 0 0;font-size:14px;color:#0a2540;font-weight:600;">${eventVenue}</p>
                          <p style="margin:2px 0 0;font-size:13px;color:#64748b;">${eventLocation}</p></td>
                    </tr></table>
                  </td></tr>
                </table>
              </td></tr>
        ...
        <tr>
          <td style="padding:0 40px 32px;">
            <p style="margin:0;font-size:14px;color:#64748b;line-height:1.6;">
              Can't make it? Just reply to this email and let us know as soon as possible so we can offer your spot to someone else.
            </p>
          </td>
        </tr>
